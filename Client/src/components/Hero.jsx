...
const Hero = () => {
  return (
    <div className="relative isolate px-6 pt-14 lg:px-8">
      ...
      <div className="mx-auto w-fit py-28 sm:py-48 lg:py-48 xl:max-w-[800px] 2xl:w-full flex flex-col justify-center md:justify-start">
        <motion.div
        ...
        >
          ...
          <div className="text-center">
            <h1 className="text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl md:text-6xl xl:text-7xl ">
